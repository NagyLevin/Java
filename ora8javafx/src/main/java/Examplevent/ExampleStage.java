...
public class ExampleStage extends Application {
  ...
  protected MenuItem mExit, mButton, mCheck, mText, mGraphics, mImage,
      mKeyboard, mMouse, mAnimation;
  private VBox root;
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    primaryStage.setResizable(false); // Az ablak ne legyen átméretezhető
