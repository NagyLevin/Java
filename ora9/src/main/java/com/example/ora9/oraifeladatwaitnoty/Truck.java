...
import static com.example.ora9.oraifeladatwaitnoty.Factory.Products;
...
public class Truck implements Runnable {
     ...
     * @throws IOException
     */
    public Truck(String host) throws UnknownHostException, IOException {
        ...
        try {
            ...
            while (fogyaszsak == true) {
                ...
                synchronized (Products){
                    Products.wait(); // addig vár amig nem lát notify allt ezután felébredés

                    System.out.println("Felébredt a ");// ez a rész lefut
