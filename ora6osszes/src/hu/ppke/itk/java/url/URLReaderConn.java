...
public class URLReaderConn {
    ...
    public void read() {
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(testConn.getInputStream()));
    ...
    public void testPostMethod() {
        try {
            ...
            OutputStreamWriter osw = new OutputStreamWriter(testConn.getOutputStream());
            PrintWriter pw = new PrintWriter(osw, true);
            pw.print("testPOST=tesztelgetunk...");
            pw.close();
